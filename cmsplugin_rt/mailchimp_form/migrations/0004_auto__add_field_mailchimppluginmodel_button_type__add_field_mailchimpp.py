...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_mailchimppluginmodel', 'button_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'MailChimpPluginModel.button_size'
        db.add_column('cmsplugin_mailchimppluginmodel', 'button_size',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailChimpPluginModel.button_type'
        db.delete_column('cmsplugin_mailchimppluginmodel', 'button_type')

        # Deleting field 'MailChimpPluginModel.button_size'
        db.delete_column('cmsplugin_mailchimppluginmodel', 'button_size')
