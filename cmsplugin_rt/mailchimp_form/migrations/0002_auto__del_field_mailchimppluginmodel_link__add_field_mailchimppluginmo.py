...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MailChimpPluginModel.link'
        db.delete_column('cmsplugin_mailchimppluginmodel', 'link')

        # Adding field 'MailChimpPluginModel.form_action'
        db.add_column('cmsplugin_mailchimppluginmodel', 'form_action',
                      self.gf('django.db.models.fields.URLField')(default='#', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MailChimpPluginModel.link'
        db.add_column('cmsplugin_mailchimppluginmodel', 'link',
                      self.gf('django.db.models.fields.URLField')(default='#', max_length=200),
                      keep_default=False)

        # Deleting field 'MailChimpPluginModel.form_action'
        db.delete_column('cmsplugin_mailchimppluginmodel', 'form_action')
