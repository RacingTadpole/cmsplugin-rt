...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailChimpPluginModel'
        db.create_table('cmsplugin_mailchimppluginmodel', (
    ...
    def backwards(self, orm):
        # Deleting model 'MailChimpPluginModel'
        db.delete_table('cmsplugin_mailchimppluginmodel')
