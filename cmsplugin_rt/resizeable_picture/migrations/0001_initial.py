...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResizeablePicturePluginModel'
        db.create_table('cmsplugin_resizeablepicturepluginmodel', (
    ...
    def backwards(self, orm):
        # Deleting model 'ResizeablePicturePluginModel'
        db.delete_table('cmsplugin_resizeablepicturepluginmodel')
    ...
    models = {
        ...
        'resizable-picture.resizeablepicturepluginmodel': {
